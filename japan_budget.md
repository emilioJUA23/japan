# Japan Trip — Budget Tracker
<!-- EXCEL IMPORT NOTES:
  - Each section = one Excel sheet/tab
  - Columns are consistent per section: Category | Item | Low (USD) | High (USD) | Planned (USD) | Actual (USD) | Notes
  - "Low" and "High" are estimates; fill "Planned" when decided; fill "Actual" after spending
  - All monetary values in USD (convert ¥ at ~150 JPY/USD — verify before trip)
  - Leave Actual blank until spent
-->
...
| Traveler | Luis |
| Duration (days) | 30 |
| Departure City | Guatemala City (GUA) |
| Arrival City | Tokyo (NRT or HND) |
| Season | Cherry Blossom — Late March to Early April |
| Target Year | 2027 |
...
|---|---|---|---|---|---|---|
| Flight | Round-trip Economy GUA→TYO | 1200 | 2200 | | | Book 6–9 months ahead; cherry blossom = peak pricing |
...
### Flight Research Summary
| Source | One-Way (USD) | Round-Trip (USD) | URL |
|---|---|---|---|
| Expedia | 672 | 1095 | https://www.expedia.com/lp/flights/gua/nrt/guatemala-city-to-tokyo |
...
| Common US hubs | Los Angeles (LAX), Dallas/Fort Worth (DFW), Houston (IAH) |
| Best airlines | United (via IAH/LAX), American + JAL codeshare (via DFW/LAX), ANA |
| Best booking window | October – November 2026 for March 2027 travel |
| Cheapest departure day | Thursday |
| Cheapest booking day | Sunday |
| Visa required | No — Guatemala passport is visa-free for Japan (up to 90 days) |
...
## TAB 3 — IN-JAPAN TRANSPORT

| Category | Item | Low (USD) | High (USD) | Planned (USD) | Actual (USD) | Notes |
|---|---|---|---|---|---|---|
| Transport | JR Pass — 30 days | 600 | 670 | | | Buy before leaving Guatemala; covers most Shinkansen |
| Transport | Suica / Pasmo IC card (loaded cash) | 50 | 100 | | | Metro, buses, convenience stores |
| Transport | Taxis — miscellaneous | 50 | 100 | | | Japan taxis are pricey; use sparingly |
| Transport | Day trip trains not covered by JR | 30 | 80 | | | Private lines in Kyoto / Osaka area |
| **TRANSPORT TOTAL** | | **730** | **950** | | | Excludes domestic flights (see TAB 1) |

---

## TAB 4 — FOOD & DRINK

| Category | Item | Low/Day (USD) | High/Day (USD) | Days | Low Total (USD) | High Total (USD) | Planned (USD) | Actual (USD) | Notes |
|---|---|---|---|---|---|---|---|---|---|
| Food | Convenience store meals | 5 | 10 | 30 | 150 | 300 | | | 7-Eleven / FamilyMart / Lawson |
...
## TAB 6 — SHOPPING & SOUVENIRS

| Category | Item | Low (USD) | High (USD) | Planned (USD) | Actual (USD) | Notes |
|---|---|---|---|---|---|---|
| Shopping | Manga / anime merch (Akihabara, Nakano Broadway) | 50 | 500 | | | Easy to overspend — set a hard limit |
| Shopping | Martial arts gear (Okinawa / Tokyo dojo shops) | 50 | 300 | | | Gi, equipment, books |
| Shopping | Clothing / fashion (Harajuku, Shimokitazawa) | 50 | 400 | | | Vintage, streetwear |
| Shopping | Food souvenirs / omiyage | 50 | 150 | | | Kit Kats, wagashi, matcha products |
| Shopping | General gifts for family / friends | 50 | 200 | | | |
| **SHOPPING TOTAL** | | **250** | **1550** | | | Set your limit before entering Akihabara |

---

## TAB 7 — CONNECTIVITY & MISC

| Category | Item | Low (USD) | High (USD) | Planned (USD) | Actual (USD) | Notes |
|---|---|---|---|---|---|---|
| Connectivity | Pocket WiFi rental — 30 days | 80 | 120 | | | Rent at NRT airport; IIJmio / Sakura Mobile |
| Connectivity | OR: SIM card — 30 days | 40 | 80 | | | IIJmio, Mobal — data only; pick one or the other |
| Insurance | Travel insurance — 30 days | 80 | 200 | | | Do not skip — Japan healthcare is expensive for tourists |
| Misc | Luggage storage / coin lockers | 30 | 80 | | | ~$5–10/use; helpful on travel days |
| Misc | Laundry (coin laundromats) | 30 | 60 | | | ~$3–6/load; available everywhere |
| Misc | Toiletries / pharmacy | 50 | 100 | | | Matsumoto Kiyoshi chain is great |
| Misc | Cash buffer (JPY on hand) | 100 | 200 | | | Japan is cash-heavy; always carry ¥10,000–¥20,000 |
| **MISC TOTAL** | | **370** | **760** | | | |

---

## TAB 8 — PRE-TRIP ONE-TIME COSTS

| Category | Item | Low (USD) | High (USD) | Planned (USD) | Actual (USD) | Done | Notes |
|---|---|---|---|---|---|---|---|
| Pre-trip | JR Pass 30-day (buy before leaving) | 600 | 670 | | | No | Must purchase outside Japan |
| Pre-trip | Travel insurance | 80 | 200 | | | No | |
| Pre-trip | Luggage / gear upgrades | 0 | 200 | | | No | |
| Pre-trip | Vaccinations / prescriptions | 0 | 150 | | | No | Check with doctor |
| Pre-trip | Guidebooks / apps / prep | 20 | 50 | | | No | |
| Pre-trip | Visa | 0 | 0 | | | Yes | Guatemalan passport — visa-free up to 90 days |
| **PRE-TRIP TOTAL** | | **700** | **1270** | | | | |

---

## TAB 9 — GRAND TOTAL SUMMARY
